...
def _get_patches(wrap_file: Path) -> typing.Iterable[str]:
    ...
    return [
        patch.strip()
        for patch in config["wrap-file"]["diff_files"].strip().split(",")[1:]
    ]
...
def _decode_atl_version(ATL_VER: int) -> str:
    return f"{ATL_VER >> 8}.{ATL_VER & 0xFF}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("_ATL_VER", help="Value of _ATL_VER ATL macro")
    ...
    msys2_adbwinapi = {
        ...
        "externalReferences": [
            {
                "type": "website",
                "url": "https://github.com/msys2/adbwinapi",
            },
            {
                "type": "vcs",
                "url": "https://github.com/msys2/adbwinapi.git",
            },
            {
                "type": "issue-tracker",
