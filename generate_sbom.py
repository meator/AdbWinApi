...
# # initialize_build_template.py, otherwise your changes #
...
#
# You will have to modify this script. A failure to do so will lead to discrepancies in
# the generated SBOM.
#
    ...
    if "url" in first_patch["diff"]:
        ...
        for secondary_patch in secondary_group:
            if secondary_patch["diff"]["url"] not in urls:
                allowed_secondary_group.append(secondary_patch)
    else:
...
if __name__ == "__main__":
    ...
    msys2_adbwinapi = {
        ...
        "externalReferences": [
            {"type": "website", "url": "https://github.com/msys2/adbwinapi"},
            {"type": "vcs", "url": "https://github.com/msys2/adbwinapi.git"},
            {
                "type": "issue-tracker",
                "url": "https://github.com/msys2/adbwinapi/issues",
            },
            apache_license_extref,
        ],
    }
    ...
    document = {
        ...
        "metadata": {
            ...
            "component": {
                ...
                "externalReferences": [
                    {"type": "website", "url": args.base_repoling},
                    {"type": "vcs", "url": args.base_repoling + ".git"},
                    {"type": "issue-tracker", "url": args.base_repoling + "/issues"},
                    apache_license_extref,
                ],
                "licenses": [{"license": apache_license}],
