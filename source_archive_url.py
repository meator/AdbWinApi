...
# But it is only an approximation, since the release archive isn't
# stable (if you try to download it twice, you will get two files that
# aren't identical and do not have the same hash) and new updates
# shouldn't change the size of the archive that much.
